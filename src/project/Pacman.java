...
public class Pacman extends GameObject {
	/**
	 * @param _acc
	 *            se ocupa de accelerarea obiectului in fereastra cand o tasta
	 *            este apasata
	 * @param _dcc
	 *            decelerarea obiectului cand tasta nu mai este apasata
	 */
	...
	/**
	 * @param input
	 *            primeste tasta care este apasata
	 * @param handler
	 *            primeste date despre obiect
	 * @param right
	 *            deplasare pe axa Y pozitiv
	 * @param left
	 *            deplasare pe axa Y negativ
	 * @param up
	 *            deplasare pe axa X pozitiv
	 * @param down
	 *            deplasare pe axa X negativ
	 */
	 ...
	 *            personaj
	 * @param input
	 *            tastare care se apasa
	 * @param handler
	 *            coordonator pentru obiect
	 */
	 ...
	 * 
	 * @param value
	 *            viteaza cu care de deplasare
	 * @param min
	 *            valorea minima cu care se depleseaza obiectul
	 * @param max
	 *            valorea maxima cu care se deplaseaza obiectul
